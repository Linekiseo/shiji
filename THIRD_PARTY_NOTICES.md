...
Dependency versions are pinned in `app/package-lock.json`. Third-party packages retain their respective licenses.

| Component | License | Source |
| --- | --- | --- |
| React / React DOM | MIT | https://github.com/facebook/react |
| Capacitor and official plugins | MIT | https://github.com/ionic-team/capacitor |
| Phosphor Icons | MIT | https://github.com/phosphor-icons/react |
| Radix Dialog | MIT | https://github.com/radix-ui/primitives |
